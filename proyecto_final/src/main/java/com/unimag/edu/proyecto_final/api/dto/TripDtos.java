...
public class TripDtos {
    ...
    public record TripResponse(Long id, Long routeId, Long busId, LocalDate date, LocalDateTime departureAt, LocalDateTime arrivalEta, String status) implements Serializable {}
