...
public class TicketDtos {
    public record TicketCreateRequest(Long tripId, Long passengerId, String seatNumber, Long fromStopId, Long toStopId, Double price, String paymentMethod) implements Serializable {}
